...
La interfaz usa auto-scroll inteligente: mientras la IA responde en streaming, si el usuario permanece al final del chat la vista sigue bajando automáticamente. Si el usuario sube para revisar mensajes anteriores, la app deja de forzar el scroll y muestra un botón flotante para volver al final.

## Última actualización UX

- Botón flotante para volver al final del chat centrado sobre la caja de escritura.
- Acciones rápidas en mensajes del usuario: copiar y editar como nueva consulta.
- Botón de detener respuesta durante streaming: el botón de enviar cambia a `■` mientras la IA está generando.

## Gestión de proyectos y chats

- Usa el botón `⋯` de cada proyecto para renombrarlo o eliminarlo.
- Usa el botón `⋯` de cada chat para renombrarlo, moverlo a otro proyecto o eliminarlo.
- El Proyecto General está protegido contra eliminación, pero puede renombrarse si necesitas personalizarlo.
